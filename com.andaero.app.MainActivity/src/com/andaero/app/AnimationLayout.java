...
public class AnimationLayout extends ViewGroup
{
    ...
    protected int mSidebarWidth = 340; // by default
	...
	mSidebar = findViewById(R.id.main_layout_sidebar);
	mContent = findViewById(R.id.main_layout_content);
    ...
    {
	/* the max width of Sidebar is 99.9% of Parent */
	if (child == mSidebar)
	{
	int mode = MeasureSpec.getMode(parentWSpec);
	int width = (int) (getMeasuredWidth() * 0.999);
